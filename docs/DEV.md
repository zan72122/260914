...
| 仕事の結果の判定 | 仕様上の範囲 | 実測 |
|---|---|---|
| 銅: 作業灯の領域の平均輝度 | 仕事の後に 1.5 倍以上 | 0.1450 → 0.3689（2.54 倍） |
| ストロンチウム: 沖の赤成分 | 仕事の間に 1.5 倍以上、色相が赤 | 55.5 → 107.6（1.94 倍）, 346.2° |
| ストロンチウム: 救助船の光の領域の輝度 | 仕事の後に 1.5 倍以上 | 0.1995 → 0.5097（2.56 倍） |
| リチウム: リモコンのランプの輝度 | 仕事の後に 1.3 倍以上 | 0.1512 → 0.3719（2.46 倍） |

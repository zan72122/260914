// STUB — strontium world. Engineer A placeholder; owner of src/worlds/strontium.js replaces this file
...
//   - call engine.audio.speakElement('strontium') exactly once, at the climax.
//   - call finish({worldId:'strontium', completed:true, returnHandoff, shelfAnchorHint}) when done.
//   - NEVER draw text.

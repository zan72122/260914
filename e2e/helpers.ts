...
import { hueOf } from '../src/flame/elementColors';
...
export function analyzePng(buffer: Buffer, minValue = 0.35, minSat = 0.18): RegionColor {
  ...
  return { hue, coloredRatio: colored / total, luma: lumaSum / total, samples: total };
}
